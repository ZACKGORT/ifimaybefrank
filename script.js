    ...
    <div className="wrapper">
      ...
      <div className="header-section">
        ...
        <h1 className="main-title">Hello!</h1>
				<h2 className="sub-title">I'm Zack (Sr. UX Designer) but <span className="span">if I may be frank:</span></h2>
        <p className="description">
          Here's some of my UX work, condensed conveniently for your consideration. More @ <a href="https://reasonandresolution.com/"><strong>reasonandresolution.com</strong></a>.
        </p>
      </div>
...
<div className="client-info">
  <strong>Client:</strong> {clientInfo[activeTab].client} <br />
  <strong>Role:</strong> {clientInfo[activeTab].company}
</div>
